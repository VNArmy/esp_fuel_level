...
void uart_init(UartBautRate uart0_br,UartBitsNum4Char uart0_db,UartParityMode uart0_pm, UartStopBitsNum uart0_sb
...
void uart0_SetWordLength( UartBitsNum4Char len);
void uart0_SetStopBits(UartStopBitsNum bit_num);
void uart0_SetParity(UartParityMode Parity_mode);
#endif /* __UART_H__ */

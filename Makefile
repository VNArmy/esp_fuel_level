...
ESPTOOL		?= esptool.py#$(abspath ../../esp-open-sdk/esptool/esptool.py)
ESPPORT		?= /dev/ttyUSB0
ESPBAUD		?= 230400
...
ET_FF               ?= 40m     # 80Mhz flash speed in esptool flash command
...
MODULES		  	+= espfs httpd user serial  esp-link level
